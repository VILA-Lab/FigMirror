...
<h2 id="paper-results">📝 Paper & Results</h2>

Our [arXiv preprint](https://arxiv.org/abs/2608.28814),
[*FigMirror: Ground It, Code It, Plot It*](https://arxiv.org/pdf/2608.28814)
(August 28, 2026), introduces PlotTwin-Bench for reference-conditioned
scientific-figure style transfer.

The paper reports a 150-instance evaluation subset: all 50 hand-curated
references and 100 randomly sampled augmented references. FigMirror achieves
...
<p align="center">
  <img src="docs/assets/evaluation/qualitative-comparison.png" alt="Qualitative style-transfer comparison of FigMirror, Plot2Code, METAL, ChartGalaxy, and ChartIR on two references" width="100%"/>
</p>
